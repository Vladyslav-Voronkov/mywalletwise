                ...
                Object.keys(state.expCategories).map((key) => (
                    <>
                        <div className="mt-5 w-3/5 md:w-1/6 self-stretch shrink-0 text-white text-center">
                            <div className="shrink-0 bg-gradient-to-b bg-black  bg-opacity-30 backdrop-blur-md card drop-shadow-xl p-5 text-white rounded-3xl text-center hover:bg-opacity-50 duration-300 cursor-pointer ml-5">
